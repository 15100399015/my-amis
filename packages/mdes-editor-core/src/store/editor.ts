...
import type {JSONSchema, Schema} from 'mdes';
import {toast, resolveVariable} from 'mdes';
...
import type {DialogSchema} from '../../../mdes/src/renderers/Dialog';
import type {DrawerSchema} from '../../../mdes/src/renderers/Drawer';
...
export const MainStore = types
  .model('EditorRoot', {
    isMobile: false,
    isSubEditor: false,
    // 用于自定义爱速搭中的 mdes 文档路径
    mdesDocHost: types.optional(types.string, 'https://baidu.gitee.io'),
