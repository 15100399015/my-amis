...
import type {RendererConfig, Schema} from 'mdes-core';
import type {MenuDivider, MenuItem} from 'mdes-ui/lib/components/ContextMenu';
import type {BaseSchema, SchemaCollection} from 'mdes';
