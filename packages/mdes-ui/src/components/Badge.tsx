...
import {evalExpression, buildStyle} from 'mdes-core';
import {resolveVariable, resolveVariableAndFilter} from 'mdes-core';
import {ClassNamesFn} from 'mdes-core';

/**
 * Badge 角标。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/badge
 */
