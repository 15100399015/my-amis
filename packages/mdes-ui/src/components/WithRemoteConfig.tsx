...
import type {RendererEnv} from 'mdes-core';
import {isPureVariable, resolveVariableAndFilter, tokenize} from 'mdes-core';
import {reaction, comparer} from 'mobx';
import {createObject, findTreeIndex, isObject} from 'mdes-core';
            ...
            if (isPureVariable(source)) {
              this.toDispose.push(
                reaction(
                  ...
                  () => this.syncConfig(),
                  // 当nav配置source: "${mdesStore.app.portalNavs}"时，切换页面就会触发source更新
