...
export const defaultOptions: RenderOptions = {
  ...
  enableMDESDebug:
    (window as any).enableMDESDebug ??
    location.search.indexOf('mdesDebug=1') !== -1 ??
    false,
  loadRenderer,
  fetcher() {
  ...
  isCancel() {
    console.error(
      'Please implement isCancel. see https://aisuda.bce.baidu.com/mdes/zh-CN/start/getting-started#%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97'
    );
    return false;
  },
  updateLocation() {
    console.error(
      'Please implement updateLocation. see https://aisuda.bce.baidu.com/mdes/zh-CN/start/getting-started#%E4%BD%BF%E7%94%A8%E6%8C%87%E5%8D%97'
    );
  },
...
// 可以后续补充点，比如 mdes 自己实现的，prompt 里面的表单。
