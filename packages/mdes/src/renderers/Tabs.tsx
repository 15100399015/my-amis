...
import {Renderer, RendererProps, resolveEventData} from 'mdes-core';
import {ActionObject, Schema, SchemaNode} from 'mdes-core';
...
import {Tabs as CTabs, Tab} from 'mdes-ui';
import {ClassNamesFn} from 'mdes-core';
import {
  BaseSchema,
  SchemaClassName,
  SchemaCollection,
...
import {resolveVariable, tokenize, resolveVariableAndFilter} from 'mdes-core';
import {FormHorizontal} from 'mdes-core';
import {str2AsyncFunction} from 'mdes-core';
import {ScopedContext, IScopedContext} from 'mdes-core';
import type {TabsMode} from 'mdes-ui/lib/components/Tabs';
...
/**
 * 选项卡控件。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/tabs
 */
