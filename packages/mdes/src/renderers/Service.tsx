...
import {Renderer, RendererProps, filterTarget} from 'mdes-core';
import {ServiceStore, IServiceStore} from 'mdes-core';
import {Api, RendererData, ActionObject} from 'mdes-core';
...
import {Spinner, SpinnerExtraProps, Alert2 as Alert} from 'mdes-ui';
import {
  autobind,
  isObject,
  isEmpty,
...
import {IIRendererStore} from 'mdes-core';

import type {ListenerAction} from 'mdes-core';
import type {ScopedComponentType} from 'mdes-core';
...
/**
 * Service 服务类控件。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/service
 */
