...
import {createObject, Renderer, RendererProps} from 'mdes-core';
import {Overlay} from 'mdes-core';
import {PopOver} from 'mdes-core';
import {TooltipWrapper} from 'mdes-ui';
import {isDisabled, isVisible, noop, filterClassNameObject} from 'mdes-core';
import {filter, buildTestId, getTestId} from 'mdes-core';
import {Icon, hasIcon} from 'mdes-ui';
import {
  BaseSchema,
  SchemaClassName,
  SchemaCollection,
...
import {RootClose} from 'mdes-core';
import type {
  TooltipObject,
  Trigger
} from 'mdes-ui/lib/components/TooltipWrapper';
import {resolveVariableAndFilter} from 'mdes-core';
import {isMobile} from 'mdes-core';
...
/**
 * 下拉按钮渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/dropdown-button
 */
