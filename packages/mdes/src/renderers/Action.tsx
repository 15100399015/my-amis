...
import {BadgeObject, Button, SpinnerExtraProps} from 'mdes-ui';
...
export interface DialogActionSchema extends ButtonSchema {
  ...
  /**
   * 弹框详情
   * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/dialog
   */
...
export interface DrawerActionSchema extends ButtonSchema {
  ...
  /**
   * 抽出式弹框详情
   * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/drawer
   */
...
export interface ToastActionSchema extends ButtonSchema {
  ...
  /**
   * 轻提示详情
   * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/toast
   */
...
/**
 * 按钮动作渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/action
 */
...
import {ClassNamesFn, themeable, ThemeProps} from 'mdes-core';
import {autobind, createObject} from 'mdes-core';
import {
  BaseSchema,
  FeedbackDialog,
  SchemaApi,
...
import {withBadge, Icon} from 'mdes-ui';
import {normalizeApi, str2AsyncFunction} from 'mdes-core';
