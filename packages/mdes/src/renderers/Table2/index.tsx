...
import {Icon, Table, BadgeObject, SpinnerExtraProps} from 'mdes-ui';
import type {
  SortProps,
  ColumnProps,
  OnRowProps,
...
} from 'mdes-ui/lib/components/table';
import {
  BaseSchema,
  SchemaObject,
...
/**
 * Table 表格2渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/table2
 */
