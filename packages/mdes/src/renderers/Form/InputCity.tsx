...
import {CityArea} from 'mdes-ui';
import {autobind, isMobile, createObject} from 'mdes-core';
import {ActionObject} from 'mdes-core';
import {Option} from 'mdes-core';
import {localeable, LocaleProps} from 'mdes-core';
import {FormBaseControlSchema} from '../../Schema';
import {supportStatic} from './StaticHoc';

/**
 * City 城市选择框。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/city
 */
...
const loadDb = (callback: (db: any) => void): void => {
  import('mdes-ui/lib/components/CityDB').then(callback);
};
