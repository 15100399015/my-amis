...
import {FormItem, FormBaseControl, FormControlProps} from 'mdes-core';
import {FormulaPicker} from 'mdes-ui';
...
import type {FormulaPickerInputSettings} from 'mdes-ui/lib/components/formula/Picker';

/**
 * InputFormula 公式编辑器
 * 文档：https://baidu.gitee.io/mdes/zh-CN/components/form/input-formula
 */
