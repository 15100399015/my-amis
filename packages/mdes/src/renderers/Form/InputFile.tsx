...
import {Payload, ApiObject, ApiString, ActionObject} from 'mdes-core';
import {qsstringify, createObject, guid, isEmpty} from 'mdes-core';
import {
  buildApi,
  isEffectiveApi,
  normalizeApi,
...
import {TooltipWrapper, Button} from 'mdes-ui';
import DropZone from 'react-dropzone';
import {FileRejection} from 'react-dropzone';
import {dataMapping} from 'mdes-core';
import {
...
/**
 * File 文件上传控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/file
 */
export interface FileControlSchema extends FormBaseControlSchema {
  ...
  /**
   * 默认为 'auto' mdes 所在服务器，限制了文件上传大小不得超出10M，所以 mdes 在用户选择大文件的时候，自动会改成分块上传模式。
   */
