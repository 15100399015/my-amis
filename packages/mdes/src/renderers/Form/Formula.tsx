...
import {evalJS, filter} from 'mdes-core';
import {autobind, isObjectShallowModified, setVariable} from 'mdes-core';
import {FormBaseControlSchema} from '../../Schema';

/**
 * 公式功能控件。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/formula
 */
