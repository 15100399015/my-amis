...
import type {PresetColor} from 'mdes-ui';
import {isMobile} from 'mdes-core';
import {FormBaseControlSchema} from '../../Schema';
import {supportStatic} from './StaticHoc';

// todo mdes-ui 里面组件直接改成按需加载
export const ColorPicker = React.lazy(
  () => import('mdes-ui/lib/components/ColorPicker')
);

/**
 * Color 颜色选择框
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/color
 */
