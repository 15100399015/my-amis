...
import {buildApi, isValidApi, isEffectiveApi} from 'mdes-core';
import {Checkbox, Spinner, SpinnerExtraProps} from 'mdes-ui';
import {setVariable, createObject} from 'mdes-core';
import {ApiObject, ActionObject, isMobile} from 'mdes-core';
import {FormBaseControlSchema, SchemaApi} from '../../Schema';
import {supportStatic} from './StaticHoc';

/**
 * Matrix 选择控件。适合做权限勾选。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/matrix
 */
