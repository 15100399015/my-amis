...
import {ActionObject, isObject} from 'mdes-core';
import type {BadgeObject} from 'mdes-ui';
import {getLevelFromClassName, autobind, isEmpty} from 'mdes-core';
import {ButtonGroupSchema} from '../ButtonGroup';
import {supportStatic} from './StaticHoc';

/**
 * 按钮组控件。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/button-group
 */
