...
import {FormItem, FormControlProps} from 'mdes-core';
import {JSONSchemaEditor} from 'mdes-ui';
import {autobind, isObject} from 'mdes-core';
import {FormBaseControlSchema} from '../../Schema';

import {schemaEditorItemPlaceholder} from 'mdes-ui';
import type {SchemaEditorItemPlaceholder} from 'mdes-ui';
import {isMobile} from 'mdes-core';

/**
 * JSON Schema Editor
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/json-schema-editor
 */
