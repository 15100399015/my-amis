...
import {LazyComponent} from 'mdes-core';
import {normalizeApi} from 'mdes-core';
import {ucFirst, anyChanged} from 'mdes-core';
import type {FormBaseControlSchema, SchemaApi} from '../../Schema';

/**
 * RichText
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/input-rich-text
 */
...
function loadRichText(
  ...
  return () =>
    type === 'tinymce'
      ? import('mdes-ui/lib/components/Tinymce').then(item => item.default)
      : import('mdes-ui/lib/components/RichText').then(item => item.default);
}
