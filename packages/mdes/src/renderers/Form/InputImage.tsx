...
import {Payload, ActionObject} from 'mdes-core';
import {
  buildApi,
  isEffectiveApi,
  normalizeApi,
...
import {createObject, qsstringify, guid, isEmpty, qsparse} from 'mdes-core';
import {Icon, TooltipWrapper, Button} from 'mdes-ui';
import accepts from 'attr-accept';
import {getNameFromUrl} from './InputFile';
import ImageComponent, {ImageThumbProps} from '../Image';
import {TranslateFn} from 'mdes-core';
...
/**
 * Image 图片上传控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/image
 */
