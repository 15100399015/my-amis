...
import {filterDate, isPureVariable, resolveVariableAndFilter} from 'mdes-core';
import moment from 'moment';
import {DatePicker} from 'mdes-ui';
import {FormBaseControlSchema, SchemaObject} from '../../Schema';
import {createObject, anyChanged, isMobile, autobind} from 'mdes-core';
import {ActionObject} from 'mdes-core';
import {supportStatic} from './StaticHoc';

import type {ShortCuts} from 'mdes-ui/lib/components/DatePicker';
...
/**
 * Date日期选择控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/date
 */
...
/**
 * Datetime日期时间选择控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/datetime
 */
...
/**
 * Time 时间选择控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/time
 */
...
/**
 * Month 月份选择控件
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/form/Month
 */
