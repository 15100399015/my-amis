...
import {Renderer, RendererProps, numberFormatter, stripNumber} from 'mdes-core';
import moment from 'moment';
import {BaseSchema} from '../Schema';
import isNumber from 'lodash/isNumber';
import {getPropValue, Option, PlainObject, normalizeOptions} from 'mdes-core';

/**
 * Number 展示渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/number
 */
