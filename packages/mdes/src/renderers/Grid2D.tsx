...
import {buildTestId, Renderer, RendererProps} from 'mdes-core';
import {Api, SchemaNode, Schema, ActionObject} from 'mdes-core';
import {isVisible} from 'mdes-core';
...
/**
 * 二维布局渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/grid-2d
 */
