...
import {buildApi, isApiOutdated} from 'mdes-core';
import {BaseSchema, SchemaUrlPath} from '../Schema';
import {ActionSchema} from './Action';
import {dataMapping, resolveVariableAndFilter} from 'mdes-core';

/**
 * IFrame 渲染器
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/iframe
 */
export interface IFrameSchema extends BaseSchema {
  ...
  /**
   * 事件相应，配置后当 iframe 通过 postMessage 发送事件时，可以触发 MDES 内部的动作。
   */
  events?: {
