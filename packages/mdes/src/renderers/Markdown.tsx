...
import {getPropValue} from 'mdes-core';
import {isApiOutdated, isEffectiveApi} from 'mdes-core';

/**
 * Markdown 渲染
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/markdown
 */
...
function loadComponent(): Promise<any> {
  return import('mdes-ui/lib/components/Markdown').then(item => item.default);
}
