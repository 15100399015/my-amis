...
import {ScopedContext, IScopedContext, filterTarget} from 'mdes-core';
import {Renderer, RendererProps} from 'mdes-core';
import {ServiceStore, IServiceStore} from 'mdes-core';
import {Api, ActionObject} from 'mdes-core';
import {filter, evalExpression} from 'mdes-core';
import {toNumber} from 'mdes-core';
import {
  createObject,
  until,
  isVisible,
...
import {isApiOutdated, isEffectiveApi} from 'mdes-core';
import {IFormStore} from 'mdes-core';
import {Spinner, SpinnerExtraProps} from 'mdes-ui';
import {Steps} from 'mdes-ui';
import {findDOMNode} from 'react-dom';
import {resizeSensor} from 'mdes-core';
import {
  BaseSchema,
  FormSchema,
  SchemaApi,
...
import {tokenize, evalExpressionWithConditionBuilder} from 'mdes-core';
...
/**
 * 表单向导
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/wizard
 */
export interface WizardSchema extends BaseSchema, SpinnerExtraProps {
  ...
  /**
   * Wizard 用来保存数据的 api。
   * [详情](https://baidu.github.io/mdes/docs/api#wizard)
   */
  api?: SchemaApi;
