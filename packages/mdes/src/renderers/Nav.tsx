...
import {themeable, ThemeProps} from 'mdes-core';
import {Icon, SpinnerExtraProps, SearchBox} from 'mdes-ui';
import {BadgeObject} from 'mdes-ui';
import {RemoteOptionsProps, withRemoteConfig} from 'mdes-ui';
import {Spinner, Menu} from 'mdes-ui';
import {ScopedContext, IScopedContext} from 'mdes-core';
import type {NavigationItem} from 'mdes-ui/lib/components/menu';
import type {MenuItemProps} from 'mdes-ui/lib/components/menu/MenuItem';

import type {Payload} from 'mdes-core';
import type {
  BaseSchema,
  SchemaObject,
  SchemaApi,
...
/**
 * Nav 导航渲染器
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/nav
 */
