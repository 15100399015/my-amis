...
import {createObject, Renderer, RendererEnv, RendererProps} from 'mdes-core';
import {Api, Payload} from 'mdes-core';
import {
  BaseSchema,
  SchemaApi,
...
import {withStore} from 'mdes-ui';
import {flow, Instance, types} from 'mobx-state-tree';
import {getPropValue, guid, isObject} from 'mdes-core';
import {StoreNode} from 'mdes-core';
...
/**
 * Mapping 映射展示控件。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/mapping
 */
