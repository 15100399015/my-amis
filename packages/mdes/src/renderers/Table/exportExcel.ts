...
import {filter, isEffectiveApi, arraySlice, isObject} from 'mdes-core';
import './ColumnToggler';
import {TableStore} from 'mdes-core';
...
import {toDataURL, getImageDimensions} from 'mdes-core';
...
const loadDb = () => {
  // @ts-ignore
  return import('mdes-ui/lib/components/CityDB');
};
