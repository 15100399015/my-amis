...
import {AnchorNav as CAnchorNav, AnchorNavSection} from 'mdes-ui';
import {isVisible, autobind} from 'mdes-core';
import {filter} from 'mdes-core';
import {BaseSchema, SchemaClassName, SchemaCollection} from '../Schema';

/**
 * AnchorNavSection 锚点区域渲染器
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/anchor-nav
 */
