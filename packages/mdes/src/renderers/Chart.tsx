...
import {resolveVariableAndFilter, isPureVariable, dataMapping} from 'mdes-core';
import {
  isApiOutdated,
  isEffectiveApi,
...
import {createObject, findObjectsWithKey} from 'mdes-core';
import {
  BaseSchema,
  SchemaApi,
  SchemaExpression,
...
import {ApiObject} from 'mdes-core';
...
/**
 * Chart 图表渲染器。
 * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/components/carousel
 */
