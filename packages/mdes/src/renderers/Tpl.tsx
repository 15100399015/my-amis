...
import {filter, asyncFilter} from 'mdes-core';
import isEmpty from 'lodash/isEmpty';
import {anyChanged, getPropValue} from 'mdes-core';
import {escapeHtml} from 'mdes-core';
import {BaseSchema, SchemaTpl} from '../Schema';
import {BadgeObject, withBadge} from 'mdes-ui';
import {buildStyle} from 'mdes-core';
...
export interface TplSchema extends BaseSchema {
   ...
   * 指定为模板渲染器。
   *
   * 文档：https://aisuda.bce.baidu.com/mdes/zh-CN/docs/concepts/template
   */
  type: 'tpl' | 'html';
