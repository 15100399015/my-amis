...
import '../../../src';
import {render as mdesRender, clearStoresCache} from '../../../src';
    ...
    mdesRender(
      {
        ...
        api: 'https://aisuda.bce.baidu.com/mdes/api/mock2/form/saveForm',
        body: [
          {
            type: 'input-table',
            name: 'table',
...
// 对应 github issue: https://github.com/baidu/mdes/issues/8263
...
// 对应 github issue: https://github.com/baidu/mdes/issues/9494
...
// 对应 github issue: https://github.com/baidu/mdes/issues/9520
    ...
    mdesRender(
      {
        ...
        body: {
          ...
          api: '/mdes/api/mock2/form/saveForm',
          body: [
            {
              showIndex: true,
              type: 'input-table',
...
// 对应 github issue: https://github.com/baidu/mdes/issues/9537
