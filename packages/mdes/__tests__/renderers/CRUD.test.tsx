...
import '../../src';
import {clearStoresCache, render as mdesRender} from '../../src';
    ...
    mdesRender(
      {
        ...
        body: {
          type: 'crud',
          syncLocation: false,
          api: 'https://aisuda.bce.baidu.com/mdes/api/mock2/sample',
          loadDataOnce: true,
          autoGenerateFilter: {
            columnsNum: 4,
          ...
          bulkActions: [
            {
              label: '批量删除',
              actionType: 'ajax',
              api: 'delete:/mdes/api/mock2/sample/${ids|raw}',
              confirmText: '确定要批量删除?'
            }
          ],
          columns: [
        ...
        bulkActions: [
          ...
          },
          {
            ...
            dialog: {
              ...
              body: {
                type: 'form',
                api: '/mdes/api/mock2/sample/bulkUpdate2',
                body: [
                  {
                    type: 'hidden',
                    name: 'ids'
