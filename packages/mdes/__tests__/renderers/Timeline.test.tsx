...
test('Renderer:timeline mode direction', async () => {
  ...
  const {container, rerender} = render(mdesRender(schema, {}, makeEnv()));
  expect(container).toMatchSnapshot();

  rerender(mdesRender({...schema, mode: 'left'}, {}, makeEnv()));
  expect(container).toMatchSnapshot();

  rerender(mdesRender({...schema, mode: 'alternate'}, {}, makeEnv()));
  expect(container).toMatchSnapshot();

  rerender(mdesRender({...schema, direction: 'horizontal'}, {}, makeEnv()));
  expect(container).toMatchSnapshot();

  rerender(mdesRender({...schema, reverse: true}, {}, makeEnv()));
  expect(container).toMatchSnapshot();
});
