...
describe('Renderer:image', () => {
  ...
  test('image:name', async () => {
    const imageUrl =
      'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80';
  ...
  test('image:title & imageCaption', async () => {
    const {container} = render(
      mdesRender({
        type: 'image',
        src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80',
        title: '这是标题',
        imageCaption: '这是一段说明'
      })
    );
  ...
  test('image:enlargeAble & originalSrc & enlargeTitle & showToolbar', async () => {
    const {container, getByText, baseElement} = render(
      mdesRender({
        ...
        src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80',
        originalSrc:
          'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg',
        enlargeAble: true,
        enlargeTitle: '这是一个标题',
  ...
  test('image:width & height', async () => {
    const {container, getByText, baseElement} = render(
      mdesRender({
        ...
        width: '200px',
        height: '200px',
        src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_400,l_1,f_jpg,q_80'
      })
    );
    ...
    const {container} = render(
      mdesRender({
        ...
        data: {
          imageUrl:
            'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg',
          imageHref: 'https://github.com/baidu/mdes'
        },
        body: {
          type: 'image',
          name: 'imageUrl',
      ...
      mdesRender(
        {
          ...
          data: {
            imageList: [
              'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692942/d8e4992057f9.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395693148/1314a2a3d3f6.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395693379/8f2e79f82be0.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395693566/552b175ef11d.jpeg@s_0,w_216,l_1,f_jpg,q_80'
            ]
          },
          body: [
            {
          ...
          images: [
            {
              image:
                'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692722/4f3cb4202335.jpeg',
              title: '图片1',
              description: '图片1的描述'
            },
            {
              image:
                'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692942/d8e4992057f9.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395692942/d8e4992057f9.jpeg',
              title: '图片2',
              description: '图片2的描述'
            },
            {
              image:
                'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395693148/1314a2a3d3f6.jpeg@s_0,w_216,l_1,f_jpg,q_80',
              src: 'https://internal-mdes-res.cdn.bcebos.com/images/2020-1/1578395693148/1314a2a3d3f6.jpeg',
              title: '图片3',
              description: '图片3的描述'
            }
          ]
