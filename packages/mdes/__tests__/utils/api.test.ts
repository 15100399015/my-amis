...
import {buildApi, isApiOutdated, isValidApi} from 'mdes-core';
...
test('api:isvalidapi', () => {
  ...
  expect(
    isValidApi(
      'https://3xsw4ap8wah59.cfc-execute.bj.baidubce.com/api/mdes-mock/mock2/sample/${id}'
    )
  ).toBeTruthy();

  expect(
    isValidApi(
      'https://3xsw4ap8wah59.cfc-execute.bj.baidubce.com/api/mdes-mock/mock2/sample/${id ? "a" : "b"}'
    )
  ).toBeTruthy();

  expect(
    isValidApi(
      'https://3xsw4ap8wah59.cfc-execute.bj.baidubce.com/api/mdes-mock/mock2/${id ? "a" : "b"}/abc'
    )
  ).toBeTruthy();
});
