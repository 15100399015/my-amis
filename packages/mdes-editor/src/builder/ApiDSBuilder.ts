...
import {isObject} from 'mdes-core';
import {toast} from 'mdes';
import {
  getSchemaTpl,
  tipedLabel,
  generateNodeId,
...
import type {ColumnSchema} from 'mdes/lib/renderers/Table2';
import type {EditorNodeType} from 'mdes-editor-core';
import type {ButtonSchema} from 'mdes';
import type {
  DSRendererType,
  DSFeatureType,
  GenericSchema,
