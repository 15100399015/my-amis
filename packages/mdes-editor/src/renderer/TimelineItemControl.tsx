...
import {render as mdesRender, FormItem, Icon} from 'mdes';
import {getI18nEnabled} from 'mdes-editor-core';
import {autobind} from 'mdes-editor-core';
        ...
        {source === 'custom' ? (
          <div className="ae-TimelineItemControl-wrapper">
            ...
            <div className="ae-TimelineItemControl-footer">
              {mdesRender(this.buildAddSchema(), {
                onSubmit: this.handleAdd
              })}
              {mdesRender(this.buildBatchAddSchema(), {
