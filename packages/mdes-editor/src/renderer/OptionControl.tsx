...
import {
  ...
  Icon,
  InputBox,
  render as mdesRender
} from 'mdes';
import {value2array} from 'mdes-ui/lib/components/Select';

import {autobind, getI18nEnabled} from 'mdes-editor-core';
import {getSchemaTpl} from 'mdes-editor-core';
import {tipedLabel} from 'mdes-editor-core';

import type {Option} from 'mdes';
import {createObject, FormControlProps} from 'mdes-core';
import type {OptionValue} from 'mdes-core';
import type {SchemaApi} from 'mdes';
      ...
      <li className="ae-OptionControlItem" key={index}>
        <div className="ae-OptionControlItem-Main">
          ...
          {render(
            ...
            {
              popOverContainer: null // mdes 渲染挂载节点会使用 this.target
            }
          )}
        </div>
        {editDom}
