...
import {autobind, getSchemaTpl, setSchemaTpl} from 'mdes-editor-core';
import {tipedLabel} from 'mdes-editor-core';
import {FormControlProps} from 'mdes-core';
import {FormItem, Icon, TooltipWrapper} from 'mdes';
import {TooltipObject} from 'mdes-ui/lib/components/TooltipWrapper';
  ...
  genTooltipProps(content: any, othersProps?: TooltipObject) {
    ...
    return {
      ...
      ...(typeof content === 'string'
        ? {content}
        : {
            content: ' ', // mdes缺陷，必须有这个字段，否则显示不出来
            children: () =>
