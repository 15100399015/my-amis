...
import {Icon, FormItem, TooltipWrapper, Spinner} from 'mdes';
import {autobind, FormControlProps, render as renderMdes} from 'mdes-core';
import {CodeMirrorEditor, FormulaEditor} from 'mdes-ui';
import type {VariableItem, CodeMirror} from 'mdes-ui';
...
> {
  ...
  async handleFormulaEditorOpen() {
    ...
    try {
      ...
      console.error(
        '[mdes-editor][TextareaFormulaControl] onFormulaEditorOpen failed: ',
        error?.stack
      );
    }
