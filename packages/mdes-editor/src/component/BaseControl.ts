...
import {getSchemaTpl, isObject, tipedLabel} from 'mdes-editor-core';
...
export function remarkTpl(config: {
  ...
  return {
    ...
    form: {
      ...
      body: {
        type: 'grid',
        className: 'pt-4 right-panel-pop :MDESCSSWrapper',
        gap: 'lg',
        columns: [
          {
            md: '6',
          ...
          },
          {
            ...
            body: [
              ...
              getSchemaTpl('icon'),
              {
                ...
                label: tipedLabel(
                  'CSS 类名',
                  '有哪些辅助类 CSS 类名？请前往 <a href="https://baidu.gitee.io/mdes/zh-CN/style/index" target="_blank">样式说明</a>，除此之外你可以添加自定义类名，然后在系统配置中添加自定义样式。'
                ),
                type: 'input-text'
              },
              {
